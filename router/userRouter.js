...
class UserRouter{
  ...
  async getOrder(req, res) {
     ...
     putUserInfo(req,res)
    {
     ...
     return this.userService.putUserInfo(req.user.id,req.body.username,req.body.firstname,req.body.surname,req.body.address,req.body.district,req.body.phone).catch(e=>console.log(e))
    }
